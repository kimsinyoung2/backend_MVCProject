        ...
        <form action="commentModify" method="post">
            <table>
           	    <tr style="display:none;">
                    <th>게시판번호</th>
                    <td><input class="form-control" type="text" size="100px" name="bno" value="${comment.bno}"></td>
                </tr> 
                
                <tr style="display:none;">
                    <th>댓글번호</th>
                    <td><input class="form-control" type="text" size="100px" name="cno" value="${comment.cno}"></td>
                </tr>         
                <tr>
                    <th>내용</th>
                    <td>
                    	<textarea class="form-control" id="contents" cols="145" rows="15" name="content">${comment.content}</textarea>
                    </td>
                </tr>
            </table>
            <div class="d-flex justify-content-end" style=" margin-top:30px">
                <button type="submit" class="btn btn-primary me-2">수정</button>
                <button type="button" class="btn btn-secondary" onclick="location.href='get?bno=<c:out value="${comment.bno}"/>'">취소</button>
            </div>
        </form>
