...
<head>
    ...
    <style>
        ...
        .navbar{
            background-color: rgb(160, 123, 207);
        }
...
<body>
	<nav class="navbar">
	  <div class="container-fluid">
        <a style="color: blue;" class="navbar-brand" href="mapleTable"><img style="margin-bottom: 8px;margin-right: 5px"width="25px"src="/resources/img/메이플.png"><b>메이플스토리</b></a>
	...
	<div id="mapleVanner">
        <img src="/resources/img/메이플배너.png" width="100%"alt="">
    </div>

    <div id="mdiv">
            <a href="https://maplestory.nexon.com/Home/Main" target="_blank" style="text-decoration: none;"><h1 id="mline">메이플스토리 바로가기</h1></a>
    </div>
    ...
    <footer>
        <img src="/resources/img/메이플푸터.png" width="100%" alt="">
    </footer>
